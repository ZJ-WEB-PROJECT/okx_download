...
const i18n = {
  ...
  en: {
    ...
    step1Desc: "",
    step2: "Step 2",
    step2Title: "Open the phone \"Settings\" > \"General\" > \"VPN & Device Management\".",
    step2Desc:"",
    step3: "Step 3",
    step3Title: "Under \"Enterprise App\", select \"Trust\" this App.",
    step3Desc:
  ...
  es: {
    ...
    step1Desc:"",
    step2: "Paso 2",
    step2Title: "Abre la configuración de tu teléfono > «General» > «VPN y gestión de dispositivos».",
    step2Desc:"",
    step3: "Paso 3",
    step3Title: "En \"Aplicaciones empresariales\", selecciona \"Confiar\" en esta aplicación.",
    step3Desc:
  ...
  ar: {
    ...
    step1Desc: "",
    step2: "الخطوة 2",
    step2Title: "أفتح الإعدادات على هاتفك > «العام» > «VPN وإدارة الأجهزة».",
    step2Desc:"",
    step3: "الخطوة 3",
    step3Title: "تحت \"التطبيقات المنظمة\"، اختر \"الوثوق بها\" في هذا التطبيق.",
  ...
  fr: {
    ...
    step1Desc: "",
    step2: "Étape 2",
    step2Title: "Ouvrez les paramètres de votre téléphone > «Général» > «VPN et gestion des appareils».",
    step2Desc:"",
    step3: "Étape 3",
    step3Title: "Sous \"Applications professionnelles\", sélectionnez \"Confiance\" pour cette application.",
